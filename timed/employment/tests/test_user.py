...
def test_user_delete_superuser(superadmin_client, user, employment_factory):
    """Should not be able delete a user."""
...
def test_user_delete_with_reports_superuser(
    superadmin_client, user, report_factory, employment_factory
):
...
def test_user_transfer(
    superadmin_client, user, employment_factory, absence_type_factory, absence_factory
):
    employment_factory.create(user=superadmin_client.user)
