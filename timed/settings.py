...
REDMINE_AMOUNT_OFFERED_FIELD = env.int("DJANGO_REDMINE_AMOUNT_OFFERED_FIELD", default=1)
REDMINE_AMOUNT_INVOICED_FIELD = env.int(
    "DJANGO_REDMINE_AMOUNT_INVOICED_FIELD", default=2
)
REDMINE_BUILD_PROJECT = env.str("DJANGO_REDMINE_BUILD_PROJECT", default="build")
