...
def test_notify_changed_employments(db, mailoutbox, freezer, employment_factory):
    ...
    finished = employment_factory.create(end_date=date(2017, 10, 10), percentage=80)
    new = employment_factory.create(percentage=100)
